...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/7.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/7.data',
                        frameworkUrl: 'Build/7.framework.js',
                        codeUrl: 'Build/7.wasm',
                        streamingAssetsUrl: 'StreamingAssets',
                        companyName: 'PlayD Games Studio',
                        productName: 'Paperly(WebGL)',
                        productVersion: '0.1',
