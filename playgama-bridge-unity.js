...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/Build Mr Driver.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/Build Mr Driver.data.unityweb',
                        frameworkUrl: 'Build/Build Mr Driver.framework.js.unityweb',
                        codeUrl: 'Build/Build Mr Driver.wasm.unityweb',
                        streamingAssetsUrl: 'StreamingAssets',
                        companyName: 'Ample Games',
                        productName: 'MR DRIVER',
                        productVersion: '1.1',
