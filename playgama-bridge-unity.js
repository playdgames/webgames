...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/Crazy Fall Build.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/Crazy Fall Build.data',
                        frameworkUrl: 'Build/Crazy Fall Build.framework.js',
                        codeUrl: 'Build/Crazy Fall Build.wasm',
                        streamingAssetsUrl: 'StreamingAssets',
                        companyName: 'Ample Games',
                        productName: 'Crazy Dead Fall',
                        productVersion: '1.0',
