...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/00 build Combo Cab.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/00 build Combo Cab.data.gz',
                        frameworkUrl: 'Build/00 build Combo Cab.framework.js.gz',
                        codeUrl: 'Build/00 build Combo Cab.wasm.gz',
                        streamingAssetsUrl: 'StreamingAssets',
                        companyName: 'Ample Game Studios',
                        productName: 'Combo Cab Simulator 3D',
                        productVersion: '1.0',
