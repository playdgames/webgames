...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/Build Driver.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/Build Driver.data.unityweb',
                        frameworkUrl: 'Build/Build Driver.framework.js.unityweb',
                        codeUrl: 'Build/Build Driver.wasm.unityweb',
